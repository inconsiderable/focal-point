...
// CountHeaderHasher is used to more efficiently hash JSON serialized count headers while rendering.
type CountHeaderHasher struct {
...
// NewCountHeaderHasher returns a newly initialized CountHeaderHasher
func NewCountHeaderHasher() *CountHeaderHasher {
...
func (h *CountHeaderHasher) initBuffer(header *CountHeader) {
...
func (h *CountHeaderHasher) Update(rendererNum int, header *CountHeader) (*big.Int, int64) {
...
// func (h *CountHeaderHasher) updateDevice(rendererNum int, header *CountHeader, bufferChanged bool) int64 {
// 	if bufferChanged {
